...
namespace speedTestdotNET
{
    class Program
    {
        ...
        /// <summary>
        /// Selects the best server by ping parameter
        /// </summary>
        /// <param name="servers" collection of nearby servers></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// received a collection of servers that are closest
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// displays the current speed for the specified parameter
        /// </summary>
        /// <param name="type" a parameter that reflects the received speed></param>
        /// <param name="speed" the speed of a certain parameter></param>
